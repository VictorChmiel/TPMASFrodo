 ...
 */
public class BoundLog <V extends Addable<V>> implements Bound<V> {
	...
	public double sampleBound(int index, SearchNode<V> node) {
		return Math.sqrt(2*Math.log(2*node.frequencie)/node.actionFrequencies[index]);
	}
