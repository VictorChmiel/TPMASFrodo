...
public class ODPOPagentTestFullDomain < V extends Addable<V>, U extends Addable<U> > extends TestCase implements IncomingMsgPolicyInterface<String> {
	...
	public static TestSuite suite () {
		TestSuite suite = new TestSuite ("Random tests for ODPOPagentFullDomain");
		
		TestSuite tmp = new TestSuite ("Tests using QueueIOPipes and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and integer utilities and real-valued variables");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableReal, AddableInteger> ("testRandomSharedMemory", false, false, null, AddableReal.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and real utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableInteger, AddableReal> ("testRandomSharedMemory", false, false, null, AddableInteger.class, AddableReal.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and the central mailer and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and the central mailer with delays and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, true, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using TCP pipes and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestFullDomain<AddableInteger, AddableInteger> ("testRandomTCP", false, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
	...
	public void setUp () throws Exception {
		...
		agentDesc = XCSPparser.parse("src/frodo2/algorithms/odpop/ODPOPagentFullDomain.xml", false);
