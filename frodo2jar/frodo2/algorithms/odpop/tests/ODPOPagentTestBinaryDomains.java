...
import frodo2.algorithms.odpop.UTILpropagationBinaryDomains;
 ...
 */
public class ODPOPagentTestBinaryDomains < V extends Addable<V>, U extends Addable<U> > extends TestCase implements IncomingMsgPolicyInterface<String> {
	...
	private UTILpropagationBinaryDomains<V, U> statsGathererUTIL;
	 ...
	 */
	public ODPOPagentTestBinaryDomains(String string, boolean useCentralMailer, boolean useDelay, String startMsgType, Class<V> domClass, Class<U> utilClass) {
		super (string);
	...
	public static TestSuite suite () {
		TestSuite suite = new TestSuite ("Random tests for ODPOPagentBinaryDomains");
		
		TestSuite tmp = new TestSuite ("Tests using QueueIOPipes and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and integer utilities and real-valued variables");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableReal, AddableInteger> ("testRandomSharedMemory", false, false, null, AddableReal.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and real utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableReal> ("testRandomSharedMemory", false, false, null, AddableInteger.class, AddableReal.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and the central mailer and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and the central mailer with delays and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, true, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using TCP pipes and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableInteger> ("testRandomTCP", false, false, null, AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and a different type of start message and integer utilities");
		tmp.addTest(new RepeatedTest (new ODPOPagentTestBinaryDomains<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, "START NOW!", AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
	...
	public void setUp () throws Exception {
		...
		agentDesc = XCSPparser.parse("src/frodo2/algorithms/odpop/ODPOPagentBinaryDomains.xml", false);
		...
		statsGathererUTIL = new UTILpropagationBinaryDomains<V, U> ((Element) null, null);
	...
	throws JDOMException, IOException, NoSuchMethodException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
		...
		problem = AllTests.createRandProblem(maxNbrVars, maxNbrEdges, maxNbrAgents, maximize, 0, true);
