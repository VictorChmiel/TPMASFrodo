 ...
 */
public class UTILdomMsg < Val extends Addable<Val>, U extends Addable<U> > 
extends UTILmsg<Val, U> {
	...
	/** Empty constructor */
	public UTILdomMsg () {
		super.type = UTILpropagationFullDomain.UTIL_MSG_DOM;
	}

	/** @see UTILmsg#writeExternal(java.io.ObjectOutput) */
	...
	/** @see UTILmsg#readExternal(java.io.ObjectInput) */
	 ...
	 */
	public UTILdomMsg(String sender, String receiver, Good<Val, U> good, int[] domInfo) {
		super(UTILpropagationFullDomain.UTIL_MSG_DOM, sender, receiver, good);
