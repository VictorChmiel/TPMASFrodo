...
/** Tests for MGM */
package frodo2.algorithms.localSearch.mgm.tests;
 ...
 */
public class MGMagentTest < V extends Addable<V>, U extends Addable<U> > extends TestCase  implements IncomingMsgPolicyInterface<String> {
	 ...
	 */
	public MGMagentTest(boolean useXCSP, boolean useTCP, boolean countNCCCs, boolean useCentralMailer, String startMsgType, Class<V> domClass, Class<U> utilClass) {
		super ("testRandom");
	...
	public static TestSuite suite () {
		TestSuite suite = new TestSuite ("Random tests for MGMagent");
		
		TestSuite tmp = new TestSuite ("Tests MGM using QueueIOPipes and AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, false, false, false, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and AddableInteger utilities without XCSP");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (false, false, false, false, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and AddableInteger utilities and real-valued variables");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableReal, AddableInteger> (true, false, false, false, null, AddableReal.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and the central mailer AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, false, false, true, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, false, true, false, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs AddableInteger utilities without XCSP");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (false, false, true, false, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs and the central mailer AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, false, true, true, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using TCP pipes AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, true, false, false, null, AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and a different type of start message AddableInteger utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableInteger> (true, false, false, false, "START NOW!", AddableInteger.class, AddableInteger.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, false, false, false, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and AddableReal utilities without XCSP");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (false, false, false, false, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and the central mailer AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, false, false, true, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, false, true, false, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs AddableReal utilities without XCSP");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (false, false, true, false, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and NCCCs and the central mailer AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, false, true, true, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using TCP pipes AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, true, false, false, null, AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests MGM using QueueIOPipes and a different type of start message AddableReal utilities");
		tmp.addTest(new RepeatedTest (new MGMagentTest<AddableInteger, AddableReal> (true, false, false, false, "START NOW!", AddableInteger.class, AddableReal.class), 50));
		suite.addTest(tmp);
	...
	public void setUp () throws Exception {
		...
		agentDesc = XCSPparser.parse("src/frodo2/algorithms/localSearch/mgm/MGMagent.xml", false);
	...
	public void testRandom () {
		...
		statsGatherer = new MGM<V, U> (null, problem);
	...
	public void notifyIn(Message msg) {
		...
		else if (msgType.equals(MGM.OUTPUT_MSG_TYPE)) {
