...
/** JUnit test suite for all the tests in frodo2.algorithms.afb.test
 * @author Alexandra Olteanu, Thomas Leaute
 */
public class AllTestsAFB 
{
	/** @return The suite of unit tests */
	public static Test suite() {
		TestSuite suite = new TestSuite("All tests in frodo2.algorithms.afb.test");
		suite.addTest(AFBagentTest.suite());
		return suite;
	}
}
