 ...
 *
 */
public class ASODPOPagentTest < V extends Addable<V>, U extends Addable<U> > extends TestCase implements IncomingMsgPolicyInterface<String> {
	 ...
	 */
	public ASODPOPagentTest(String string, boolean useXCSP, boolean useCentralMailer, boolean useDelay, Class<V> domClass, Class<U> utilClass, boolean maximize, int sign) {
		super (string);
	...
	public static TestSuite suite () {
		TestSuite suite = new TestSuite ("Random tests for ASODPOPagent");
		
		TestSuite tmp = new TestSuite ("Tests using QueueIOPipes with integer utilities");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, false, false, AddableInteger.class, AddableInteger.class, true, +1), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes with integer utilities and without XCSP");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, false, AddableInteger.class, AddableInteger.class, true, +1), 500));
		suite.addTest(tmp);
		...
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, false, false, AddableInteger.class, AddableInteger.class, true, 0), 500));
		suite.addTest(tmp);
		...
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, false, AddableInteger.class, AddableInteger.class, true, 0), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes with integer utilities on minimization problems with unrestricted cost signs");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, false, false, AddableInteger.class, AddableInteger.class, false, 0), 500));
		suite.addTest(tmp);
		...
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, false, AddableInteger.class, AddableInteger.class, false, 0), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes with integer utilities and real-valued variables");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableReal, AddableInteger> ("testRandomSharedMemory", true, false, false, AddableReal.class, AddableInteger.class, true, +1), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes with real utilities");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableReal> ("testRandomSharedMemory", true, false, false, AddableInteger.class, AddableReal.class, true, +1), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes with real utilities and without XCSP");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableReal> ("testRandomSharedMemory", false, false, false, AddableInteger.class, AddableReal.class, true, +1), 500));
		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using QueueIOPipes and the central mailer with integer utilities");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, true, false, AddableInteger.class, AddableInteger.class, true, +1), 500));
		suite.addTest(tmp);
...
//		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", true, true, true, AddableInteger.class, AddableInteger.class, true, +1), 5000));
//		suite.addTest(tmp);
		
		tmp = new TestSuite ("Tests using TCP pipes with integer utilities");
		tmp.addTest(new RepeatedTest (new ASODPOPagentTest<AddableInteger, AddableInteger> ("testRandomTCP", true, false, false, AddableInteger.class, AddableInteger.class, true, +1), 500));
		suite.addTest(tmp);
	...
	public void setUp () throws Exception {
		...
		agentDesc = XCSPparser.parse("src/frodo2/algorithms/asodpop/ASODPOPagent.xml", false);
	...
	InstantiationException, IllegalAccessException, InvocationTargetException {
		...
		statsGatherer = new ASODPOP<V, U> (null, problem);
