 ...
 */
public class MessageWith4Payloads < T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable > extends Message {
	...
	public MessageWith4Payloads <T1, T2, T3, T4> clone () {
		return new MessageWith4Payloads <T1, T2, T3, T4> (getType(), payload1, payload2, payload3, payload4);
	}
	...
	/** @param payload4 the third payload to set */
